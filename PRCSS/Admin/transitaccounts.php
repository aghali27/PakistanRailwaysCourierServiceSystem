...
<head>
    ...
    <link href="../Assets/CSS/transitaccounts.css" rel="stylesheet" type="text/css">
    <script src="../Assets/JavaScript/adminshared.js" type="text/javascript"></script>
    <script src="../Assets/JavaScript/transitaccounts.js" type="text/javascript"></script>
</head>
<body>
    ...
    <div class="row">
        ...
        <div id="incontent">
            <div class="searchheading">
                <p id="subheading">Transit Accounts</p>
            </div>
            ...
            <div class="tab-content">
                ...
                <div id="search" class="search-panel tab-pane fade">
                    ...
                    <form class="input-group style" action="accountsearchresults.php" method="post">
                        ...
                        <input type="hidden" name="domain" value="transit">
                ...
                $profilequery = "SELECT * FROM employeelogin WHERE udomain='transit' AND workingstation = '$station'";
                ...
                if ($status == "true") {
                echo "<li><div class='media transit'>
                                ...
                                <div class='media-body'>
                                    ...
                                    <p>Phone No :  " . $phone . "</p>
                                    <p>Email :  " . $email . "</p>
                                    <p>Working Module :  <span class='label label-warning label-mini'>Transit</span></p>
                ...
                $profilequery = "SELECT * FROM employeelogin WHERE udomain='transit' AND status='true' AND workingstation = '$station'";
                $result = mysqli_query($con,$profilequery);
                ...
                echo "<div id='deactive' class='tab-pane fade'>
                    ...
                    <center>
                        <ul class='list-inline cards'>";
                $profilequery = "SELECT * FROM employeelogin WHERE udomain='transit' AND status='false' AND workingstation = '$station'";
                $result = mysqli_query($con,$profilequery);
