...
<head>
    ...
    <link href="../Assets/CSS/parceldetailsa.css" rel="stylesheet" type="text/css">
        ...
        <div id="incontent">
            ...
            <div class="tab-content">
                ...
                if($parcelcount > 0) {
                    ...
                    ?>
                    <div class="delete-btn" data-toggle="modal" data-target="#myModal1">Delete Record</div>
                        ...
                        <div class="modal-dialog modal-lg">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <a href="deleteparcel.php?pid=<?php echo $pid; ?>&type=<?php echo $type;?>"><button class="btn btn-danger" style="border-radius: 0;width: 45%;margin-left: 2%;font-weight: bold;float: left">Yes</button></a>
                    ...
                    while($prow = mysqli_fetch_array($sqlparcel)) {
                        ...
                        while($rsrow = mysqli_fetch_array($sqlsenderreceiver)){
                            ...
                            echo "<tr>
                                <th class='th-col' colspan='3'>Sender Details</th>
                            </tr>
                            <tr>
                                <th>Name :</th>
                            ...
                            <tr>
                                <th class='th-col' colspan='3'>Receiver Details</th>
                            </tr>
                            <tr>
                                <th>Name :</th>
                            ...
                            <tr>
                                <th class='th-col' colspan='3'>Sended By</th>
                            </tr>
                            <tr>
                    ...
                    while ($rows = mysqli_fetch_array($sqlsendingdr)) {
                        ...
                        if($stypedr == 'OC'){
                            ...
                            if($sdeleterowdr == '0'){
                                echo "<td >Package not yet received</td>";
                            }
                            echo "</tr>
                            </tbody>
                        </table>";
