...
<head>
    ...
    <title>Booking Account History</title>
    ...
    <link href="../Assets/CSS/bookingaccounthistory.css" rel="stylesheet" type="text/css">
    ...
    <div class="row">
        ...
        <div id="incontent">
            <div class='searchheading'>
                <p id='subheading' style='float: left'>Booking Officer ID: <?php echo $userid; ?></p>
                <p id='subheading' style='float: right'>Name: <?php echo $uname; ?></p>
            </div>
            <section id='no-more-tables' class='tablecontainer'>
                <?php

                $sqlallparcel = mysqli_query($con,"SELECT * FROM packagedetails WHERE source='$station' AND booking_officer_id='$userid'");
