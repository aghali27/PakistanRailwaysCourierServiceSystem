...
<head>
    ...
    <title>Search Result(Sent)</title>
    ...
    <link href="../Assets/CSS/searchsentresult.css" rel="stylesheet" type="text/css">
    ...
    <div class="row">
        <div id="mySidenav" class="sidenav">
            ...
            <ul class="sidenavcontent">
                ...
                <li class="list" id="viewlist"><div id="viewparcel"><a                 <a  data-toggle="tooltip" title="View Menu">
                        id ="viewtext"><span class="glyphicon glyphicon-calendar"></span>     Parcel's History</a></div>
        ...
        <div id="incontent">
            <div class="sub-heading">
                <p id="subheading">Search Results (Sent)</p>
            ...
            <section id="no-more-tables" class="tablecontainer">
                ...
                if($choice == 'id') {
                    ...
                    ON sending_packages.pwblt_No ='$value'  AND sending_packages.pwblt_No = packagedetails.pwblt_No AND
                    sending_packages.from_station = '$station' AND sending_packages.sendtype != 'OC'");
                } elseif($choice == 'destination'){
                    $sqlsent = mysqli_query($con, "SELECT sending_packages.pwblt_No , sending_packages.sno_of_packages , sending_packages.from_station ,
                    sending_packages.to_station , sending_packages.train_no , sending_packages.transitID , sending_packages.transitname ,
                    sending_packages.senddate , sending_packages.sendtime , packagedetails.pwblt_No , packagedetails.description ,
                    packagedetails.source
                    FROM sending_packages JOIN packagedetails
                    ON packagedetails.destination ='$value'  AND sending_packages.pwblt_No = packagedetails.pwblt_No AND
                    sending_packages.from_station = '$station' AND sending_packages.sendtype != 'OC'");
                } elseif($choice == 'sender'){
                    $sqlsent = mysqli_query($con, "SELECT sending_packages.pwblt_No , sending_packages.sno_of_packages ,
                    sending_packages.from_station , sending_packages.to_station , sending_packages.train_no , sending_packages.transitID ,
                    sending_packages.transitname ,sending_packages.senddate , sending_packages.sendtime , packagedetails.pwblt_No ,
                    packagedetails.description ,packagedetails.source , sender_recieverdetails.sender_name
                    FROM sending_packages JOIN packagedetails JOIN sender_recieverdetails
                    ON sender_recieverdetails.sender_name = '$value' AND sending_packages.pwblt_No = packagedetails.pwblt_No AND
                    sending_packages.from_station = '$station' AND sending_packages.sendtype != 'OC'");
                }
