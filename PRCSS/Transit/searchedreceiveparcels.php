...
<head>
    ...
    <title>Searched Receive Parcel</title>
    ...
    <link href="../Assets/CSS/serchedreceiveparcels.css" rel="stylesheet" type="text/css">
    ...
    <div class="row">
        ...
        <div id="incontent">
            ...
            echo "<div class='sub-heading'>
                <p id='subheading'>Search Results (Train no.".$tid.")</p>
            ...
            <div class='panel-container'>";
                ...
                sending_packages.sdeleterow='0' AND sending_packages.from_station != '$station'");
